...
RedScript 是一种可以编译成 Minecraft 数据包的脚本语言。它提供了类似 C 语言的语法，让编写 Minecraft 函数变得更加简单和高效。

## 提示
这个项目目前还处于开发阶段，所以我没有进行任何优化，可能生成的命令很多余，但是结果是真确的。
在将来，我将会进行优化，使生成的命令更精简。
这个编译器不太稳定，如果遇到BUG可以反馈，感谢反馈。

## ✨ 特性

- **类 C 语法**：易于学习的语法，支持变量声明、循环、条件判断等
